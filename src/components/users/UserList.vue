              ...
              <tr>
                ...
                >
                  ...
                  >
                    ...
                    <BarsArrowUpIcon
                      v-if="
                        sorting.currentKey === 'username' && sorting.isAscending
                      "
                      class="h-3 w-3 mx-2"
                    />
                  </button>
                ...
                >
                  ...
                  >
                    ...
                    <BarsArrowDownIcon
                      v-if="
                        sorting.currentKey === 'role' && !sorting.isAscending
                      "
                      class="h-3 w-3 mx-2"
                    />
                    <BarsArrowUpIcon
...
const { users: responseData } = storeToRefs(userStore);

const filteredResponseData = computed(() => {
  const filteredItems = responseData.value.filter((item) => {
    return (
      item.username!.toLowerCase().indexOf(searchKeyword.value?.toLowerCase()) >
      -1
    );
  });
...
function toggleSort(key: keyof IUserData) {
